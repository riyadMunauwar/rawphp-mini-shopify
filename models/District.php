<?php
    ...
    class District extends Connection {
        ...
        public function findByDistrictByNameAndStoreId($name, $store_id){
        ...
        public function deleteByStoreAndId($store_id, $district_id){
            $stmt = $this->connection->prepare("DELETE FROM $this->table WHERE store_id = :store_id AND id = :district_id");
            $stmt->bindParam(':store_id', $store_id);
