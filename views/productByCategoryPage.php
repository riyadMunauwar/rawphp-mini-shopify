...
<?php include_once VIEWS . 'partials/brandAndCategoryProductGridSection.php' ?>
    ...
    <?php 
      ...
      $categoryID =    $data['pagination']['category_id'] ?? null;
      ...
      $prevPageRoute = BASE_PATH . "category?c={$categoryID}&page={$prevPageId}";
      $nextPageRoute = BASE_PATH . "category?c={$categoryID}&page={$nextPageId}";
