        ...
        <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4 ">
            ...
            <div class="md:overflow-auto md:h-screen pb-24 md:pt-2 md:pr-2 md:pl-2 md:pt-0 md:pr-0 md:pl-0">
                        ...
                        <div class="md:rounded-lg">
                                    ...
                                    <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Create Brand</h2>
                                    ...
                                    <?php foreach($data['errors'] ?? [] as $error) { ?>
                                        ...
                                        <form action="<?php route('store/add-brand') ?>" method="POST">
                                            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">

                                                <div>
                                                    <label class="text-gray-700 dark:text-gray-200" for="brandname">Brand Name*</label>
                                                    <input name="name" id="brandname" value="<?php echo $data['formData']['name'] ?? '' ?>" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                                                </div>
                                                ...
                                                <div class="w-full mt-4">
                                                    ...
                                                    <textarea id="editor" name="description"  class="block w-full h-40 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"><?php echo $data['formData']['description'] ?? '' ?></textarea>
                                                </div>
                                            </div>
