            <!-- Header -->
            <header class="hidden md:block w-full shadow-lg bg-white dark:bg-gray-700 items-center h-16 rounded-2xl z-40">
                    ...
                    <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                        <div class="container relative left-0 z-50 flex w-3/4 h-auto h-full">
                            ...
                            <div class="relative p-1 flex items-center justify-end w-1/4 ml-5 mr-4 sm:mr-0 sm:right-auto">
                                <a href="<?php route('store/logout'); ?>" class="py-1 px-3 bg-themeSecondaryLight rounded-sm text-sm text-white font-semibold hover:bg-themeSecondaryDark hover:cursor-pointer block relativ font-bold dark:text-gray-100">
                                    Logout
