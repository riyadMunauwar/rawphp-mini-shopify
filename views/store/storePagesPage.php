                ...
                <!-- Content Start -->
                    ...
                    <section class="bg-white dark:bg-gray-700 body-font">
                        <div class="container px-5 py-10 mx-auto">
                            ...
                            <!-- Button -->
                            <div class="mb-10">
                                <a class="text-sm text-white bg-themeSecondaryLight border-0 py-2 px-6 focus:outline-none hover:themeSecondaryDark rounded-sm" href="<?php route('store/add-page?active=page'); ?>">Add Page </a>
                            </div>
                            ...
                            <div class="md:w-full  w-full mx-auto overflow-auto">
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <?php if(has('pages', $data)) { ?>
                                        ...
                                        <thead class="" >
                                            <tr class="bg-indigo-400">
                                                <th class="px-3 py-1 title-font tracking-wider font-medium text-gray-100 text-sm  rounded-tl rounded-bl">ID</th>
                                                <th class="px-3 py-1 title-font tracking-wider font-medium text-gray-100 text-sm ">Page Name</th>
                                                <th class="px-3 py-1 title-font tracking-wider font-medium text-gray-100 text-sm ">Title</th>
                                        ...
                                        <?php foreach( $data['pages'] ?? [] as $page ) { ?>
                                                    ...
                                                    <tr class="border-b hover:bg-gray-200 dark:hover:bg-gray-800 dark:text-gray-100 hover:cursor-pointer">
                                                        <td class="px-3 py-1 text-sm"><?php  echo $page['id'] ?></td>
                                                        <td class="px-3 py-1 text-sm"><?php echo $page['name'] ?? '' ?></td>
                                                        <td class="px-3 py-1 text-sm"><?php echo $page['title'] ?? '---' ?></td>
                                                        <td class="w-10 text-center text-sm">
                                                            <div class="flex justify-center space-x-2">
                                                                <a href="<?php route('store/delete-page?page-id=' . $page['id']) ?>" class="px-2 py-1 rounded-sm bg-themeSecondaryLight text-xs text-white hover:cursor-pointer hover:bg-themeSecondaryDark" > Delete</a>
                                                                <a href="<?php route('store/update-page?page-id='. $page['id']) ?>" class="px-2 py-1 rounded-sm bg-themeSecondaryLight text-xs text-white hover:cursor-pointer hover:bg-themeSecondaryDark" > Edit</a>
                                                                <a target="_blank" href="<?php route('page?n='. $page['name']) ?>" class="px-2 py-1 rounded-sm bg-themeSecondaryLight text-xs text-white hover:cursor-pointer hover:bg-themeSecondaryDark" > Preview</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                    ...
                                    <?php }else { ?>
                                        ...
                                        <h2 class="text-lg font-semibold ">No Page Available</h2>
