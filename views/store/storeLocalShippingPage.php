            ...
            <div class="md:overflow-auto md:h-screen pb-24 md:pt-2 md:pr-2 md:pl-2 md:pt-0 md:pr-0 md:pl-0">
                <!-- Content Start -->
                    <div class="bg-white p-4 pb-10">
                        ...
                        <h1 class="text-md font-semibold text-gray-600 mb-8">Add arewa where your local shipping are availabel.</h1>

                        <!-- Image Slider -->
                        <div class="mb-8">
                            <h2 class="text-sm font-semibold mb-4">District</h2>
                            <div id="" class="grid grid-cols-1 md:grid-cols-4 gap-2 mb-4">
                                ...
                                <?php if(has('imageCaurosel', $data)) { ?>
                                    ...
                                    <?php foreach($data['imageCaurosel'] ?? [] as $image) { ?>
                                        <div class="group relative">
                                            ...
                                            <form class="group-hover:block hidden absolute top-1 right-1" action="<?php route('store') ?>" method="POST">
                                ...
                                <?php } else { ?>
                                    ...
                                    <span class="text-sm font-semibold text-center">No  district added !</span>

                                <?php } ?>


                            </div>
                            <form class="border flex gap-2 items-center p-4" action="<?php route('store') ?>" method="POST">
                        ...
                        <!-- Image Slider -->
                        <div class="mb-8">
                            <h2 class="text-sm font-semibold mb-4">Upazila</h2>
                            <div id="" class="grid grid-cols-1 md:grid-cols-4 gap-2 mb-4">
                                ...
                                <?php } else { ?>
                                    ...
                                    <span class="text-sm font-semibold text-center">No  Upazila added !</span>
                        ...
                        <div>
                            <h2 class="text-sm font-semibold mb-4">Area</h2>
                            <!-- Featured Product Caurosel Items -->
                                ...
                                <?php }} else { ?>
                                    <span class="text-sm font-semibold text-center">No  Area added !</span>
                                <?php  } ?>
