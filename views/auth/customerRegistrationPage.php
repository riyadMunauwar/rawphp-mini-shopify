...
<?php include_once VIEWS . 'partials/header.php'; ?>
     ...
     <!-- Register Page -->
      <section class="md:py-10 dark:bg-gray-700">
        ...
        <div class="w-full max-w-md p-6 m-auto bg-white md:rounded-md shadow-md dark:bg-gray-800">
          <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">Register</h1>
    
          <form class="mt-6" action="<?php route('customer/register') ?>" method="POST">
            ...
            <div class="mb-4">
              <label for="Phone" class="block text-sm text-gray-800 dark:text-gray-200">Phone</label>
            ...
            <div class="mb-4">
              <label for="Confirm" class="block text-sm text-gray-800 dark:text-gray-200">Confirm</label>
              <input name="confirm" type="password" value="<?php echo $data['confirm'] ?? '' ?>"
                  class="<?php echo $data['redBorder'] ?? '' ?> block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40">
            </div>  
          ...
          <p class="mt-8 text-xs font-light text-center text-gray-400"> Already have an account? <a href="<?php route('customer/login') ?>"
