...
<?php include_once VIEWS . 'partials/header.php'; ?>
     ...
     <!-- Login Page -->
      ...
      <section class="py-10 dark:bg-gray-700">
        <div class="flex justify-center max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            <!-- <div class="hidden bg-cover lg:block lg:w-1/2" style="background-image:url('https://learnwithsumit.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogin.cc7f1c14.png&w=640&q=75')"></div> -->
            
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2 ">
                <h2 class="text-2xl font-semibold text-center text-gray-700 dark:text-white">Admin Login</h2>
                ...
                <form action="<?php echo BASE_PATH ?>admin/login" method="POST">
                   ...
                   <?php } 
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <a href="#" class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">login with email password</a>
