            ...
            try
            {
                ...
                if($productList){
                    foreach($productList as $product){
                        ...
                        array_push($productWithVariation, $product);
                ...
                view('store/storeStockPage', ['products' => $productWithVariation, 'categories' => $categories, 'pagination' => $pagination]);
                

            }
            catch(Exception $e)
            {
                echo 'This error is coming from stock product page' . $e->getMessage();
            }
